...
module.exports.lint = function (element, opts) {
    ...
    if (!(element.attribs.hasOwnProperty('type')) || !(element.attribs.type.value == 'text')) {
        return [];
    }
    ...
    var name = (element.attribs.hasOwnProperty('name')  && element.attribs.name) ? element.attribs.name.value : null;
    if (id || name) {
