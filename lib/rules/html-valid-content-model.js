...
module.exports = {
    ...
    on: ['tag'],
    filter: ['html'],
    desc: 'If set, the content-model of the <html> element will be enforced: at most one <head> and one <body> tag may appear, in that order. No other tags are allowed.'
};
